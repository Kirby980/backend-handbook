...
> 一套面向**中级到高级**后端工程师的系统进阶课程，共 **7 大专题、114 篇万字长文**，每篇含底层原理、代码示例、生产实践、陷阱清单与练习题。
>
> **📅 内容基准：2026 年 5 月** —— HTTP/3 主流、TLS 1.3 + post-quantum、PostgreSQL 18、Redis 8 / Valkey、Kafka 4 (KRaft)、Go 1.26、Istio Ambient GA、Passkeys、OAuth 2.1 + DPoP、OpenTelemetry、Prometheus 3。
...
- **2026 时效**：跟进 Go 1.26、PostgreSQL 18、Kafka 4.0、Redis 8、TLS 后量子等最新变化
...
> 每个专题的 `INDEX.md` 里都有更细致的路径建议（API 工程师特化、性能特化、架构师视角等）。
