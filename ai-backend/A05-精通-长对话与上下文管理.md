...
2026 年 5 月，Claude Sonnet 4.6 已经支持 1M context window，Gemini 2.5 Pro 支持 1M（2M 为上一代 Gemini 1.5 Pro 的能力）。听起来"再也不用管 context 了"——但工程现实正好相反：**context window 越大，浪费就越大**。本章拆开生产级长对话管理的全套技术。
