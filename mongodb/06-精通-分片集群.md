...
**balancer** 周期性检查 shard 间 chunk 数量差：

- 差超过阈值 → 迁移 chunk
- 阈值看 chunk 总数（如总 < 20 阈值 2，> 80 阈值 8）
...
```js
// 给 shard 加 tag
sh.addShardTag("sh1", "US")
sh.addShardTag("sh2", "EU")
...
> 📁 本文位于 `/data/workspace/dp4/mongodb/06-精通-分片集群.md`
