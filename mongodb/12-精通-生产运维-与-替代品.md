...
- 但**底层不是 MongoDB**（基于 PostgreSQL 改造）
- 支持 MongoDB 5.0 部分 API（约 80%）
...
- **Queryable Encryption** 支持更多 query 类型（range / 部分匹配）
- **Atlas 多云** 进一步开放
...
> 📁 本文位于 `/data/workspace/dp4/mongodb/12-精通-生产运维-与-替代品.md`
